...
% TODO: If completion was near-universal in both conditions, note that the task
% may have been straightforward enough that ceiling effects limit interpretation
% of this measure.
...
% TODO: Note that the ephemeral condition includes support-related interactions
% (e.g. support_shown, support_dismissed) in the count. If ephemeral has a higher
% count, discuss whether this reflects additional effort or simply the extra
% interaction steps introduced by the support layer.
...
% TODO: Write 1 paragraph per measure interpreting the direction and significance.
% For helpfulness: did participants rate the ephemeral condition as more helpful?
% For intrusiveness: did the ephemeral condition feel more intrusive?
% For control: did perceived control remain stable or change?
...
% TODO: Run a binomial test for the overall preference question (excluding
% "no preference" responses). Report the test result and interpret whether
% participants meaningfully favoured one condition.
...
% TODO: Interpret the engagement pattern. If most participants used the support,
% the main results are interpretable at face value. If many dismissed or ignored
% the support, note that the measured effects may understate the potential of
% ephemeral assistance (or may reflect that the support was not perceived as useful).

\subsection{Summary of Findings}

% TODO: Write a short summary (4-6 sentences) that restates the key findings
% without interpretation. Cover: completion rate, completion time, interaction
% count, subjective ratings, preference, and engagement pattern. This summary
% should be factual and serve as a bridge to the Discussion section.
