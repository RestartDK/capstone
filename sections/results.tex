...
The ephemeral condition received a higher median helpfulness rating than the baseline (\GenLikertHelpfulnessEphemeralMdn{} vs. \GenLikertHelpfulnessBaselineMdn{}), and the Wilcoxon test indicated a statistically significant difference ($p = \GenLikertHelpfulnessP{}$). Within this sample, participants therefore rated the ephemeral interface as reliably more helpful.
