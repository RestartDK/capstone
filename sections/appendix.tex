...
\begin{listing}[htbp]
\caption{Condensed excerpt of a locally captured support-generation record persisted to \texttt{support\_outputs}.}
\label{lst:local-support-trace}
\inputminted[fontsize=\scriptsize,breaklines]{json}{evidence/local-support-validation-2026-04-04.json}
\end{listing}
